...
[![actions in production](https://img.shields.io/badge/actions%20in%20production-0-brightgreen)](https://github.com/Indegosblade/hot-tamale/blob/Caliente/.github/THREAT_MODEL.md)
...
[![python](https://img.shields.io/badge/python-Yes-blue)](https://github.com/Indegosblade/hot-tamale/blob/Caliente/pyproject.toml)
[![platforms](https://img.shields.io/badge/platforms-all%20of%20them-blue)](https://github.com/Indegosblade/hot-tamale/actions/workflows/ci.yml)
[![dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://github.com/Indegosblade/hot-tamale/blob/Caliente/pyproject.toml)
[![types](https://img.shields.io/badge/types-fully%20typed-blue)](https://github.com/Indegosblade/hot-tamale/blob/Caliente/src/hot_tamale/py.typed)
[![license](https://img.shields.io/badge/license-Yes-blue)](https://github.com/Indegosblade/hot-tamale/blob/Caliente/LICENSE)
...
- **Tamper-evident** — agents are sealed after construction and self-test their own safety layer at startup. See [How it works](#how-it-works).
...
The runtime defends itself, too: agents are **sealed at construction** (no layer can be reassigned on a live instance) and run a **power-on self-test** that confirms the executor still refuses actions before the agent will vouch for anything — re-checkable at any time with `agent.verify()`.
